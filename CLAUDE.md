...
The script has a built-in 10-minute timeout per session. If plans are complex and timing out:
- Simplify the plan-generation prompt
- Break into smaller chunks
- Consider increasing timeout in `generate-and-create-linear.ts`
